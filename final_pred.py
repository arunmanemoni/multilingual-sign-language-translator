...
class Application:
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(r"C:\Users\arunm\Sign-Language-To-Text-and-Speech-Conversion\white.jpg")
    ...
    def speak_fun(self):
        ...
        #text_to_translate = self.str

        # Translate the text from English to Spanish
        #translated_text = self.translator.translate(text_to_translate, src='en', dest='es')

      
        #self.str = self.translator.translate(self.str, src=src_language, dest=dest_language)
        print(self.str)
        ...
        #tran.multilingual_text_to_speech(self.str, target_language="es")
